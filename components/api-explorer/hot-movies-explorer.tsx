...
export default function HotMoviesExplorer() {
  ...
  const handleFetch = async () => {
    ...
    setError(null)
    try {
      const res = await fetch("/api/hot-movies-series", {
        method: "GET",
  ...
  return (
    <div className="space-y-6">
      <div className="bg-blue-900/20 border border-blue-700 text-blue-300 px-4 py-3 rounded text-sm">
        <p className="font-semibold mb-1">Get hot and trending movies and TV series</p>
        <p>Discover the most popular content right now</p>
      </div>
